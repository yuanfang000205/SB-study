...
* ```java
  ...
  public class MyAspectConfig {
      ...
      @Around("@annotation(com.yuanfang.annotations.MyAdvice)") //使用注解法决定是否使用通知，使用时在相应方法@MyAdvice
...
* ```java
  ...
  ![image-20210916181916186](C:\Users\WE\AppData\Roaming\Typora\typora-user-images\image-20210916181916186.png)
